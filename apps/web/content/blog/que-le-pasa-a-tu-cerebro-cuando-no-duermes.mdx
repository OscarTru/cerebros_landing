...
readingTime: 5
headings:
  - { id: "lo-que-el-sueño-hace-que-no-puedes-hacer-despierto", text: "Lo que el sueño hace que no puedes hacer despierto", level: 2 }
  - { id: "tu-memoria-al-día-siguiente", text: "Tu memoria al día siguiente", level: 2 }
  - { id: "las-emociones-se-descontrolan", text: "Las emociones se descontrolan", level: 2 }
  - { id: "cuánto-sueño-es-suficiente", text: "¿Cuánto sueño es suficiente?", level: 2 }
  - { id: "lo-que-puedes-hacer", text: "Lo que puedes hacer", level: 2 }
---
