// Next.js App Router Route Handler — GET /api/likes?slug=xxx  |  POST /api/likes { slug }
//
// Env vars required:
//   SUPABASE_URL
...
export async function POST(req: Request): Promise<Response> {
  ...
  if (countError) {
    console.error("Supabase post-insert count error:", countError)
    return json({ error: "Could not fetch updated count" }, 500)
  }
