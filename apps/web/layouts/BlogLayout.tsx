...
// TODO: metadata exported from page file
// LazyMotion is unnecessary in framer-motion v12 — motion components handle SSR automatically
...
function ShareBar({ title, slug }: { title: string; slug: string }) {
  ...
  const [url, setUrl] = useState("") // stable SSR default — set after mount
