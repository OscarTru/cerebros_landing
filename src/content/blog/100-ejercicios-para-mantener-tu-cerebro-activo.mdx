...
readingTime: 10
headings:
  - { id: "el-sueño-como-sistema-de-limpieza", text: "El sueño como sistema de limpieza", level: 2 }
  - { id: "lo-que-el-ejercicio-hace-adentro", text: "Lo que el ejercicio hace adentro", level: 2 }
  - { id: "lo-que-comes-el-ldl-que-nadie-midió-y-el-ruido-que-ignoramos", text: "Lo que comes, el LDL que nadie midió y el ruido que ignoramos", level: 2 }
  - { id: "sobre-los-fármacos-lo-que-existe-y-lo-que-promete", text: "Sobre los fármacos: lo que existe y lo que promete", level: 2 }
  - { id: "el-ensayo-finger-y-lo-que-aprendimos-de-él", text: "El ensayo FINGER y lo que aprendimos de él", level: 2 }
  - { id: "lo-que-cambia-cuando-entiendes-esto", text: "Lo que cambia cuando entiendes esto", level: 2 }
---
