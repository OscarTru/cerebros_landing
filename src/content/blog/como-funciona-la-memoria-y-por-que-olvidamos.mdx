...
image: "memoria_afphau"
readingTime: 6
headings:
  - { id: "la-memoria-no-graba-construye", text: "La memoria no graba. Construye.", level: 2 }
  - { id: "el-olvido-no-es-un-error", text: "El olvido no es un error", level: 2 }
  - { id: "por-qué-recordamos-lo-que-recordamos", text: "Por qué recordamos lo que recordamos", level: 2 }
  - { id: "el-problema-de-los-falsos-recuerdos", text: "El problema de los falsos recuerdos", level: 2 }
  - { id: "cómo-aprovechar-esto", text: "Cómo aprovechar esto", level: 2 }
---
